...
def _tenancy_title_text_only_examples(count: int, rng: random.Random) -> list[dict[str, object]]:
    # 전대차, 임차권등기명령, 미등기 신축, 가계약금 환불불가처럼 권원/소유권 확인이 핵심인 텍스트 입력을 보강한다.
    rows: list[dict[str, object]] = []
    templates = [
        {
            "label": 0,
            "source": "synthetic_tenancy_title_safe",
            "text": "전대차가 아니라 임대인 본인과 직접 계약 임대인 동의서 이슈 없음 등기부 확인 완료",
            "contract_type": "monthly_rent",
            "property_type": "officetel",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.05, 0.18),
            "mortgage_range": (0.00, 0.06),
            "senior_range": (0.00, 0.04),
            "gap_range": (-6, 4),
            "flags": {"guarantee_insurance_available": True, "fixed_date_ready": True, "move_in_ready": True, "broker_explained_rights": True},
        },
        {
            "label": 0,
            "source": "synthetic_tenancy_title_safe",
            "text": "소유권보존등기 완료 사용승인 완료 건축물대장 정상 임대인 계좌 일치",
            "contract_type": "jeonse",
            "property_type": "villa",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.36, 0.60),
            "mortgage_range": (0.00, 0.06),
            "senior_range": (0.00, 0.03),
            "gap_range": (-8, 4),
            "flags": {"guarantee_insurance_available": True, "fixed_date_ready": True, "move_in_ready": True, "broker_explained_rights": True},
        ...
        {
            "label": 1,
            "source": "synthetic_tenancy_title_caution",
            "text": "가계약금 넣기 전 계약서 확인 필요 환불 가능 여부 특약으로 적어야 함",
            "contract_type": "jeonse",
            "property_type": "villa",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.54, 0.74),
            "mortgage_range": (0.00, 0.10),
            "senior_range": (0.00, 0.04),
            "gap_range": (0, 12),
            "flags": {"guarantee_insurance_available": True, "fixed_date_ready": True, "move_in_ready": True},
        },
        {
            "label": 1,
            "source": "synthetic_tenancy_title_caution",
            "text": "임차권등기명령 말소 완료 확인 전이라 등기부 재확인 필요",
            "contract_type": "jeonse",
            "property_type": "apartment",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.46, 0.68),
            "mortgage_range": (0.00, 0.10),
            "senior_range": (0.00, 0.06),
            "gap_range": (-2, 10),
            "flags": {"guarantee_insurance_available": True, "fixed_date_ready": True, "move_in_ready": True},
        ...
        {
            "label": 2,
            "source": "synthetic_tenancy_title_danger",
            "text": "집주인이 아니라 기존 세입자가 전대차로 계약하자고 합니다 임대인 동의서는 없고 전입신고는 가능하다고만 해요",
            "contract_type": "monthly_rent",
            "property_type": "officetel",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.08, 0.28),
        ...
        },
        {
            "label": 2,
            "source": "synthetic_tenancy_title_danger",
            "text": "등기부에 임차권등기명령이 남아 있는데 전 세입자와는 해결됐다고만 합니다",
            "contract_type": "jeonse",
            "property_type": "apartment",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.42, 0.70),
            "mortgage_range": (0.00, 0.12),
            "senior_range": (0.00, 0.08),
            "gap_range": (-2, 12),
            "flags": {
        ...
        },
        {
            "label": 2,
            "source": "synthetic_tenancy_title_danger",
            "text": "신축인데 아직 미등기이고 사용승인 전이라 등기부등본이 없다고 합니다",
            "contract_type": "jeonse",
            "property_type": "villa",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.58, 0.86),
            "mortgage_range": (0.00, 0.14),
            "senior_range": (0.00, 0.08),
            "gap_range": (4, 18),
            "flags": {
        ...
        },
        {
            "label": 2,
            "source": "synthetic_tenancy_title_danger",
            "text": "가계약금 넣으면 환불불가라고 하고 계약서 보기 전 먼저 송금하라고 합니다",
            "contract_type": "jeonse",
            "property_type": "villa",
            "legal_category": "civil_fraud_duress",
            "jeonse_range": (0.50, 0.78),
    ...
    for idx in range(count):
        template = templates[idx % len(templates)]
        label = int(template["label"])
        market = round(rng.uniform(100, 1500), 1)
        contract_type = str(template["contract_type"])
        ratio = rng.uniform(*template["jeonse_range"])
        ...
        flags = {
            ...
            "trust_registered": False,
            "illegal_building": False,
            "landlord_multiple_properties": label >= 1 and rng.random() < 0.20,
            "landlord_prior_incidents": False,
            "broker_unregistered": False,
            "broker_advertising_issue": False,
            "suspicious_special_clause": label >= 1 and rng.random() < 0.30,
            "guarantee_insurance_available": contract_type != "sale" and label == 0,
            "fixed_date_ready": label != 2,
            "move_in_ready": label != 2,
            "broker_explained_rights": label == 0,
        ...
        rows.append(
            {
                "source": template["source"],
                "source_case_number": f"TENANCY_TITLE_{idx + 1:05d}",
                "source_case_name": "전대차·임차권등기·미등기·가계약금 텍스트-only 입력 예시",
                "derivation_variant_id": idx,
                "contract_type": contract_type,
                "property_type": template["property_type"],
                "region": rng.choice(["수도권", "비수도권", "광역시", "지방중소도시"]),
                ...
                "debt_ratio": round((deposit + mortgage + senior) / max(market, 1), 4),
                "nearby_market_gap_percent": round(rng.uniform(*template["gap_range"]), 2),
                "contract_period_months": rng.choice([12, 24, 24, 36]),
                **flags,
                "danger_term_count": signals.danger_term_count,
                "registry_term_count": signals.registry_term_count,
                "broker_term_count": signals.broker_term_count,
...
def _priority_auction_text_only_examples(count: int, rng: random.Random) -> list[dict[str, object]]:
    # 전입세대열람, 선순위 보증금 총액, 경매·공매, 소유자 변경처럼 체크박스에 없는 권리순위 위험을 보강한다.
    rows: list[dict[str, object]] = []
    templates = [
        {
            "label": 0,
            "source": "synthetic_priority_auction_safe",
            "text": "전입세대열람 확인 완료 확정일자 부여현황 확인 완료 선순위 보증금 총액 확인 완료 경매 공매 없음",
            "contract_type": "jeonse",
            "property_type": "multi_family",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.28, 0.56),
            "mortgage_range": (0.00, 0.06),
            "senior_range": (0.00, 0.08),
            "gap_range": (-8, 4),
            "flags": {"guarantee_insurance_available": True, "fixed_date_ready": True, "move_in_ready": True, "broker_explained_rights": True},
        },
        {
            "label": 0,
            "source": "synthetic_priority_auction_safe",
            "text": "소유자 변경 없음 잔금 당일 대출 없음 전입 후 대출 금지 특약 등기부 확인 완료",
            "contract_type": "jeonse",
            "property_type": "apartment",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.34, 0.60),
            "mortgage_range": (0.00, 0.05),
            "senior_range": (0.00, 0.03),
            "gap_range": (-8, 3),
            "flags": {"guarantee_insurance_available": True, "fixed_date_ready": True, "move_in_ready": True, "broker_explained_rights": True},
        ...
        {
            "label": 1,
            "source": "synthetic_priority_auction_caution",
            "text": "다가구라 전입세대 자료와 확정일자 자료를 계약 전 추가 확인해야 함",
            "contract_type": "monthly_rent",
            "property_type": "multi_family",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.10, 0.32),
            "mortgage_range": (0.02, 0.14),
            "senior_range": (0.04, 0.18),
            "gap_range": (-2, 10),
            "flags": {"guarantee_insurance_available": True, "fixed_date_ready": True, "move_in_ready": True},
        },
        {
            "label": 1,
            "source": "synthetic_priority_auction_caution",
            "text": "소유권 이전 일정이 가까워 잔금 전 등기부 재확인과 임대인 본인 확인 필요",
            "contract_type": "jeonse",
            "property_type": "villa",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.52, 0.72),
            "mortgage_range": (0.00, 0.10),
            "senior_range": (0.00, 0.06),
            "gap_range": (-2, 12),
            "flags": {"guarantee_insurance_available": True, "fixed_date_ready": True, "move_in_ready": True},
        ...
        {
            "label": 2,
            "source": "synthetic_priority_auction_danger",
            "text": "다가구인데 전입세대열람을 못 보여준다고 하고 확정일자 부여현황도 집주인만 볼 수 있다며 안 보여줍니다",
            "contract_type": "jeonse",
            "property_type": "multi_family",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.38, 0.70),
            "mortgage_range": (0.00, 0.10),
            "senior_range": (0.00, 0.10),
            "gap_range": (-2, 12),
            "flags": {"guarantee_insurance_available": True, "fixed_date_ready": True, "move_in_ready": True, "broker_explained_rights": True},
        },
        {
            "label": 2,
            "source": "synthetic_priority_auction_danger",
            "text": "선순위 임차보증금 총액을 모른다고 하고 방마다 보증금 내역은 개인정보라 확인이 어렵다고 합니다",
            "contract_type": "monthly_rent",
            "property_type": "multi_family",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.10, 0.34),
            "mortgage_range": (0.00, 0.12),
            "senior_range": (0.00, 0.12),
            "gap_range": (-2, 12),
            "flags": {"guarantee_insurance_available": True, "fixed_date_ready": True, "move_in_ready": True, "broker_explained_rights": True},
        },
        {
            "label": 2,
            "source": "synthetic_priority_auction_danger",
            "text": "등기부에 임의경매개시결정이 보이는데 집주인이 곧 취하될 거라며 계약해도 된다고 합니다",
            "contract_type": "jeonse",
            "property_type": "villa",
            "legal_category": "civil_fraud_duress",
            "jeonse_range": (0.40, 0.72),
            "mortgage_range": (0.00, 0.12),
            "senior_range": (0.00, 0.08),
            "gap_range": (-2, 16),
            "flags": {"guarantee_insurance_available": True, "fixed_date_ready": True, "move_in_ready": True, "broker_explained_rights": True},
        },
        {
            "label": 2,
            "source": "synthetic_priority_auction_danger",
            "text": "공매 예고 통지를 받았다는 말이 있는데 세금 체납은 곧 해결한다고 합니다",
            "contract_type": "jeonse",
            "property_type": "officetel",
            "legal_category": "civil_fraud_duress",
            "jeonse_range": (0.42, 0.74),
        ...
        },
        {
            "label": 2,
            "source": "synthetic_priority_auction_danger",
            "text": "계약일과 잔금일 사이에 소유자가 바뀔 수 있고 매매와 전세를 동시에 진행한다고 합니다",
            "contract_type": "jeonse",
            "property_type": "villa",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.44, 0.74),
            "mortgage_range": (0.00, 0.12),
            "senior_range": (0.00, 0.08),
            "gap_range": (-2, 14),
            "flags": {"guarantee_insurance_available": True, "fixed_date_ready": True, "move_in_ready": True, "broker_explained_rights": True},
        },
        {
            "label": 2,
            "source": "synthetic_priority_auction_danger",
            "text": "잔금 당일 전입신고 전에 집주인이 대출을 먼저 실행해야 한다고 합니다",
            "contract_type": "jeonse",
            "property_type": "apartment",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.40, 0.70),
            "mortgage_range": (0.00, 0.08),
            "senior_range": (0.00, 0.05),
            "gap_range": (-2, 10),
            "flags": {"guarantee_insurance_available": True, "fixed_date_ready": True, "move_in_ready": True, "broker_explained_rights": True},
    ...
    for idx in range(count):
        ...
        rows.append(
            {
                "source": template["source"],
                "source_case_number": f"PRIORITY_AUCTION_{idx + 1:05d}",
                "source_case_name": "전입세대·선순위·경매공매·소유자변경 텍스트-only 입력 예시",
                "derivation_variant_id": idx,
                "contract_type": contract_type,
                "property_type": template["property_type"],
                "region": rng.choice(["수도권", "비수도권", "광역시", "지방중소도시"]),
...
def _document_mismatch_text_only_examples(count: int, rng: random.Random) -> list[dict[str, object]]:
    # 공적장부, 계약서, 법인 권한서류, 말소접수처럼 폼 체크박스에 없는 문서형 위험을 자유입력 텍스트로 학습한다.
    rows: list[dict[str, object]] = []
    templates = [
        {
            "label": 0,
            "source": "synthetic_document_mismatch_safe",
            "text": "대지권 등기 완료 등기부 주소와 건축물대장 호수 일치 법인등기부등본 확인 완료 사용인감계 확인 완료",
            "contract_type": "jeonse",
            "property_type": "apartment",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.32, 0.58),
            "mortgage_range": (0.00, 0.05),
            "senior_range": (0.00, 0.04),
            "gap_range": (-8, 4),
            "flags": {"guarantee_insurance_available": True, "fixed_date_ready": True, "move_in_ready": True, "broker_explained_rights": True},
        },
        {
            "label": 0,
            "source": "synthetic_document_mismatch_safe",
            "text": "근저당 말소접수 완료 전세권 설정 가능 무상거주확인서 없음 주소 호수 일치",
            "contract_type": "jeonse",
            "property_type": "villa",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.34, 0.62),
        ...
        {
            "label": 1,
            "source": "synthetic_document_mismatch_caution",
            "text": "등기부 주소와 건축물대장 호수 대조 전이라 계약 전 재확인 필요",
            "contract_type": "jeonse",
            "property_type": "villa",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.48, 0.70),
            "mortgage_range": (0.00, 0.12),
            "senior_range": (0.00, 0.08),
            "gap_range": (-2, 12),
            "flags": {"guarantee_insurance_available": True, "fixed_date_ready": True, "move_in_ready": True},
        },
        {
            "label": 1,
            "source": "synthetic_document_mismatch_caution",
            "text": "법인 임대인이라 법인등기부등본과 사용인감계 원본 대조 전 계약 보류 필요",
            "contract_type": "monthly_rent",
            "property_type": "officetel",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.10, 0.30),
        ...
        {
            "label": 2,
            "source": "synthetic_document_mismatch_danger",
            "text": "집합건물인데 등기부에 대지권 미등기라고 표시되어 있고 토지 지분은 나중에 정리된다고 합니다",
            "contract_type": "jeonse",
            "property_type": "apartment",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.40, 0.70),
        ...
        },
        {
            "label": 2,
            "source": "synthetic_document_mismatch_danger",
            "text": "등기부 주소와 건축물대장 호수가 다르고 실제 보는 방 호실도 계약서 호수와 다릅니다",
            "contract_type": "jeonse",
            "property_type": "villa",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.38, 0.68),
        ...
        },
        {
            "label": 2,
            "source": "synthetic_document_mismatch_danger",
            "text": "대출 심사를 위해 무상거주확인서에 서명해 달라고 하고 실제 보증금은 따로 주면 된다고 합니다",
            "contract_type": "jeonse",
            "property_type": "officetel",
            "legal_category": "civil_fraud_duress",
            "jeonse_range": (0.35, 0.66),
            "mortgage_range": (0.00, 0.10),
            "senior_range": (0.00, 0.08),
            "gap_range": (0, 16),
            "flags": {"guarantee_insurance_available": True, "fixed_date_ready": True, "move_in_ready": True, "broker_explained_rights": True},
        },
        {
            "label": 2,
            "source": "synthetic_document_mismatch_danger",
            "text": "보증금이 큰데 전세권 설정은 절대 안 된다고 하고 확정일자만 받으면 충분하다고 합니다",
            "contract_type": "jeonse",
            "property_type": "villa",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.54, 0.76),
            "mortgage_range": (0.00, 0.10),
            "senior_range": (0.00, 0.08),
            "gap_range": (-2, 12),
            "flags": {"guarantee_insurance_available": True, "fixed_date_ready": True, "move_in_ready": True, "broker_explained_rights": True},
        },
        {
            "label": 2,
            "source": "synthetic_document_mismatch_danger",
            "text": "임대인이 법인인데 법인등기부등본 사용인감계 인감증명 없이 직원 명함만 보여줍니다",
            "contract_type": "monthly_rent",
            "property_type": "commercial",
            "legal_category": "civil_fraud_duress",
            "jeonse_range": (0.10, 0.34),
        ...
        },
        {
            "label": 2,
            "source": "synthetic_document_mismatch_danger",
            "text": "근저당은 잔금으로 갚는다며 말소접수 전 영수증만 보여주고 먼저 입금하라고 합니다",
            "contract_type": "jeonse",
            "property_type": "apartment",
            "legal_category": "civil_fraud_duress",
            "jeonse_range": (0.42, 0.70),
    ...
    for idx in range(count):
        ...
        if contract_type == "monthly_rent":
            sale_price = 0.0
            deposit = round(market * ratio, 1)
            monthly_rent = round(rng.uniform(0.35, 2.7), 2)
        else:
            sale_price = 0.0
            deposit = round(market * ratio, 1)
            monthly_rent = 0.0
        ...
        flags = {
            ...
            "broker_unregistered": False,
            "broker_advertising_issue": False,
            "suspicious_special_clause": label >= 1 and rng.random() < 0.26,
            "guarantee_insurance_available": contract_type != "sale",
            "fixed_date_ready": True,
            "move_in_ready": True,
            "broker_explained_rights": True,
        ...
        rows.append(
            {
                "source": template["source"],
                "source_case_number": f"DOC_MISMATCH_{idx + 1:05d}",
                "source_case_name": "공적장부·계약서·권한서류 불일치 텍스트-only 입력 예시",
                "derivation_variant_id": idx,
                "contract_type": contract_type,
                "property_type": template["property_type"],
                "region": rng.choice(["수도권", "비수도권", "광역시", "지방중소도시"]),
...
def _remote_broker_document_text_only_examples(count: int, rng: random.Random) -> list[dict[str, object]]:
    # 비대면 임대인 신원확인, 중개사 등록/공제증서, 보증서 캡처, 다운계약처럼 현장에서 문장으로만 드러나는 위험을 보강한다.
    rows: list[dict[str, object]] = []
    templates = [
        {
            "label": 0,
            "source": "synthetic_remote_broker_document_safe",
            "text": "해외 체류 임대인이지만 영상통화 본인 확인 신분증 원본 대조 위임장 원본 인감증명 원본 확인 완료",
            "contract_type": "jeonse",
            "property_type": "apartment",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.32, 0.58),
        ...
        },
        {
            "label": 0,
            "source": "synthetic_remote_broker_document_safe",
            "text": "중개사 등록 확인 완료 공제증서 확인 완료 보증기관 조회 완료 계약서 실제 보증금 일치 차액 현금 없음",
            "contract_type": "jeonse",
            "property_type": "villa",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.34, 0.62),
        ...
        {
            "label": 1,
            "source": "synthetic_remote_broker_document_caution",
            "text": "임대인이 해외 체류 중이라 비대면 계약 예정이라 영상통화와 위임장 원본 확인 전 계약 보류 필요",
            "contract_type": "jeonse",
            "property_type": "officetel",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.44, 0.68),
            "mortgage_range": (0.00, 0.10),
            "senior_range": (0.00, 0.06),
            "gap_range": (-2, 10),
            "flags": {"guarantee_insurance_available": True, "fixed_date_ready": True, "move_in_ready": True},
        },
        {
            "label": 1,
            "source": "synthetic_remote_broker_document_caution",
            "text": "공제증서와 중개사무소 등록증 원본 대조 전이라 등록번호 조회 후 계약해야 합니다",
            "contract_type": "monthly_rent",
            "property_type": "villa",
            "legal_category": "realtor_prohibited_acts",
            "jeonse_range": (0.10, 0.30),
        ...
        {
            "label": 2,
            "source": "synthetic_remote_broker_document_danger",
            "text": "임대인이 해외 체류 중이라며 신분증 사진만 보내고 영상통화는 거부하며 대리인이 계약하자고 합니다",
            "contract_type": "jeonse",
            "property_type": "villa",
            "legal_category": "civil_fraud_duress",
            "jeonse_range": (0.38, 0.68),
        ...
        },
        {
            "label": 2,
            "source": "synthetic_remote_broker_document_danger",
            "text": "중개사무소 등록증을 찾아보니 폐업 상태인데 명함만 주고 공제증서는 나중에 준다고 합니다",
            "contract_type": "jeonse",
            "property_type": "apartment",
            "legal_category": "realtor_prohibited_acts",
            "jeonse_range": (0.36, 0.66),
            "mortgage_range": (0.00, 0.10),
            "senior_range": (0.00, 0.08),
            "gap_range": (-2, 12),
            "flags": {"guarantee_insurance_available": True, "fixed_date_ready": True, "move_in_ready": True, "broker_explained_rights": True},
        },
        {
            "label": 2,
            "source": "synthetic_remote_broker_document_danger",
            "text": "중개사 자격번호 없음 등록번호 조회 안됨 공제증서 만료 상태인데 계약금부터 넣으라고 합니다",
            "contract_type": "jeonse",
            "property_type": "villa",
            "legal_category": "realtor_prohibited_acts",
            "jeonse_range": (0.38, 0.68),
        ...
        },
        {
            "label": 2,
            "source": "synthetic_remote_broker_document_danger",
            "text": "중개사가 HUG 보증서가 이미 발급됐다고 PDF 캡처만 보여주고 보증기관 조회는 하지 말라고 합니다",
            "contract_type": "jeonse",
            "property_type": "officetel",
            "legal_category": "civil_fraud_duress",
            "jeonse_range": (0.38, 0.68),
        ...
        },
        {
            "label": 2,
            "source": "synthetic_remote_broker_document_danger",
            "text": "계약서에는 보증금을 낮게 쓰고 실제 보증금 차액은 현금으로 따로 주면 세금이 줄어든다고 합니다",
            "contract_type": "jeonse",
            "property_type": "villa",
            "legal_category": "civil_fraud_duress",
            "jeonse_range": (0.36, 0.66),
        ...
        },
        {
            "label": 2,
            "source": "synthetic_remote_broker_document_danger",
            "text": "직거래라 중개수수료를 아끼자며 공제증서 없이 보증서 캡처만 믿고 먼저 송금하라고 합니다",
            "contract_type": "jeonse",
            "property_type": "multi_family",
            "legal_category": "civil_fraud_duress",
            "jeonse_range": (0.34, 0.64),
            "mortgage_range": (0.00, 0.10),
            "senior_range": (0.00, 0.10),
            "gap_range": (-2, 14),
            "flags": {"guarantee_insurance_available": True, "fixed_date_ready": True, "move_in_ready": True, "broker_explained_rights": True},
    ...
    for idx in range(count):
        ...
        flags = {
            ...
            "trust_registered": False,
            "illegal_building": False,
            "landlord_multiple_properties": label >= 1 and rng.random() < 0.18,
            "landlord_prior_incidents": False,
            "broker_unregistered": False,
            "broker_advertising_issue": label >= 1 and rng.random() < 0.20,
            "suspicious_special_clause": label >= 1 and rng.random() < 0.28,
            "guarantee_insurance_available": contract_type != "sale",
            "fixed_date_ready": True,
            "move_in_ready": True,
        ...
        rows.append(
            {
                "source": template["source"],
                "source_case_number": f"REMOTE_BROKER_DOC_{idx + 1:05d}",
                "source_case_name": "비대면 신원·중개사 자격·보증서·다운계약 텍스트-only 입력 예시",
                "derivation_variant_id": idx,
                "contract_type": contract_type,
                "property_type": template["property_type"],
                "region": rng.choice(["수도권", "비수도권", "광역시", "지방중소도시"]),
...
def _settlement_gap_text_only_examples(count: int, rng: random.Random) -> list[dict[str, object]]:
    # 잔금 직전 최신 등기부, 전입·점유 공백, 대출 브로커 명의대여, 가족계좌 송금처럼 계약 막판에 문장으로 드러나는 위험을 보강한다.
    rows: list[dict[str, object]] = []
    templates = [
        {
            "label": 0,
            "source": "synthetic_settlement_gap_safe",
            "text": "잔금 당일 등기부 재열람 완료 전입신고 즉시 가능 임대인 본인 계좌 일치 전세대출 브로커 없음",
            "contract_type": "jeonse",
            "property_type": "apartment",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.30, 0.58),
            "mortgage_range": (0.00, 0.05),
            "senior_range": (0.00, 0.04),
            "gap_range": (-8, 4),
            "flags": {"guarantee_insurance_available": True, "fixed_date_ready": True, "move_in_ready": True, "broker_explained_rights": True},
        },
        {
            "label": 0,
            "source": "synthetic_settlement_gap_safe",
            "text": "최신 등기부 확인 완료 당일 전입 완료 실제 거주 확인 완료 가족 계좌 송금 없음",
            "contract_type": "monthly_rent",
            "property_type": "villa",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.08, 0.28),
            "mortgage_range": (0.00, 0.07),
            "senior_range": (0.00, 0.04),
            "gap_range": (-7, 5),
            "flags": {"guarantee_insurance_available": True, "fixed_date_ready": True, "move_in_ready": True, "broker_explained_rights": True},
        },
        {
            "label": 1,
            "source": "synthetic_settlement_gap_caution",
            "text": "등기부등본 발급일이 며칠 전이라 잔금 당일 최신 등기부 재열람 후 계약해야 합니다",
            "contract_type": "jeonse",
            "property_type": "villa",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.46, 0.68),
            "mortgage_range": (0.00, 0.10),
            "senior_range": (0.00, 0.07),
            "gap_range": (-2, 10),
            "flags": {"guarantee_insurance_available": True, "fixed_date_ready": True, "move_in_ready": True},
        },
        {
            "label": 1,
            "source": "synthetic_settlement_gap_caution",
            "text": "금요일 잔금이라 전입신고 가능 시간과 주민센터 업무시간을 계약 전에 다시 확인해야 합니다",
            "contract_type": "jeonse",
            "property_type": "officetel",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.44, 0.66),
        ...
        {
            "label": 2,
            "source": "synthetic_settlement_gap_danger",
            "text": "등기부등본은 한 달 전에 발급한 것만 보여주고 잔금 당일 재열람은 필요 없다며 거부합니다",
            "contract_type": "jeonse",
            "property_type": "villa",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.38, 0.68),
        ...
        },
        {
            "label": 2,
            "source": "synthetic_settlement_gap_danger",
            "text": "금요일 잔금을 치르지만 전입신고는 월요일에 하라고 해서 주말 동안 대항력 공백이 생깁니다",
            "contract_type": "jeonse",
            "property_type": "apartment",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.38, 0.68),
        ...
        },
        {
            "label": 2,
            "source": "synthetic_settlement_gap_danger",
            "text": "인테리어 공사가 끝나야 입주할 수 있다며 잔금 후 열흘 뒤 전입신고를 하라고 합니다",
            "contract_type": "jeonse",
            "property_type": "officetel",
            "legal_category": "civil_lease_definition",
            "jeonse_range": (0.36, 0.66),
        ...
        },
        {
            "label": 2,
            "source": "synthetic_settlement_gap_danger",
            "text": "전세대출 브로커가 실제 거주하지 않아도 명의만 빌려주면 수수료를 준다고 합니다",
            "contract_type": "jeonse",
            "property_type": "villa",
            "legal_category": "civil_fraud_duress",
            "jeonse_range": (0.34, 0.64),
        ...
        },
        {
            "label": 2,
            "source": "synthetic_settlement_gap_danger",
            "text": "임대인 본인 계좌가 막혀 있어서 배우자 계좌로 보증금을 보내라고 합니다",
            "contract_type": "jeonse",
            "property_type": "multi_family",
            "legal_category": "civil_fraud_duress",
            "jeonse_range": (0.36, 0.66),
        ...
        },
        {
            "label": 2,
            "source": "synthetic_settlement_gap_danger",
            "text": "아들 계좌로 먼저 송금하면 임대인에게 전달된다며 가족 계좌 입금을 요구합니다",
            "contract_type": "monthly_rent",
            "property_type": "villa",
            "legal_category": "civil_fraud_duress",
            "jeonse_range": (0.08, 0.30),
    ...
    for idx in range(count):
        ...
        rows.append(
            {
                "source": template["source"],
                "source_case_number": f"SETTLEMENT_GAP_{idx + 1:05d}",
                "source_case_name": "잔금 최신서류·전입공백·대출브로커·가족계좌 텍스트-only 입력 예시",
                "derivation_variant_id": idx,
                "contract_type": contract_type,
                "property_type": template["property_type"],
                "region": rng.choice(["수도권", "비수도권", "광역시", "지방중소도시"]),
...
def build_derived_contract_dataset(
    ...
    tenancy_title_examples: int = 3000,
    priority_auction_examples: int = 3000,
    document_mismatch_examples: int = 3000,
    remote_broker_document_examples: int = 2500,
    settlement_gap_examples: int = 2000,
) -> pd.DataFrame:
    ...
    derived.extend(_tenancy_title_text_only_examples(tenancy_title_examples, rng))
    derived.extend(_priority_auction_text_only_examples(priority_auction_examples, rng))
    derived.extend(_document_mismatch_text_only_examples(document_mismatch_examples, rng))
    derived.extend(_remote_broker_document_text_only_examples(remote_broker_document_examples, rng))
    derived.extend(_settlement_gap_text_only_examples(settlement_gap_examples, rng))
...
def create_manual_scenarios(path: Path = MANUAL_SCENARIOS_CSV) -> pd.DataFrame:
    scenarios = [
        ...
        {
            "scenario_id": "REALISTIC_027",
            "name": "임대인 동의 없는 기존 세입자 전대차",
            "expected_min_score": 70,
            "contract_type": "monthly_rent",
            "property_type": "officetel",
            "region": "수도권",
        ...
        {
            "scenario_id": "REALISTIC_030",
            "name": "계약서 전 가계약금 환불불가 요구",
            "expected_min_score": 64,
            "contract_type": "jeonse",
            "property_type": "villa",
            "region": "수도권",
        ...
        {
            "scenario_id": "REALISTIC_031",
            "name": "전입세대열람·확정일자 자료 미제공",
            "expected_min_score": 66,
            "contract_type": "jeonse",
            "property_type": "multi_family",
            "region": "수도권",
        ...
        {
            "scenario_id": "REALISTIC_032",
            "name": "선순위 임차보증금 총액 불명",
            "expected_min_score": 72,
            "contract_type": "monthly_rent",
            "property_type": "multi_family",
            "region": "수도권",
        ...
        {
            "scenario_id": "REALISTIC_034",
            "name": "공매 예고와 세금 체납 축소 설명",
            "expected_min_score": 78,
            "contract_type": "jeonse",
            "property_type": "officetel",
            "region": "수도권",
        ...
        {
            "scenario_id": "REALISTIC_035",
            "name": "매매·전세 동시진행 소유자 변경",
            "expected_min_score": 72,
            "contract_type": "jeonse",
            "property_type": "villa",
            "region": "수도권",
        ...
        {
            "scenario_id": "REALISTIC_036",
            "name": "잔금 당일 전입 전 대출 선행 요구",
            "expected_min_score": 76,
            "contract_type": "jeonse",
            "property_type": "apartment",
            "region": "수도권",
        ...
        {
            "scenario_id": "REALISTIC_037",
            "name": "대지권 미등기 토지 지분 미정리",
            "expected_min_score": 74,
            "contract_type": "jeonse",
            "property_type": "apartment",
            "region": "수도권",
        ...
        {
            "scenario_id": "REALISTIC_038",
            "name": "등기부·건축물대장·계약서 호수 불일치",
            "expected_min_score": 70,
            "contract_type": "jeonse",
            "property_type": "villa",
            "region": "수도권",
        ...
        {
            "scenario_id": "REALISTIC_041",
            "name": "법인 임대인 권한서류 미확인",
            "expected_min_score": 72,
            "contract_type": "monthly_rent",
            "property_type": "commercial",
            "region": "수도권",
        ...
        {
            "scenario_id": "REALISTIC_042",
            "name": "근저당 말소접수 전 영수증만 제시",
            "expected_min_score": 74,
            "contract_type": "jeonse",
            "property_type": "apartment",
            "region": "수도권",
        ...
        {
            "scenario_id": "REALISTIC_043",
            "name": "비대면 임대인 신분증 사진만 제시",
            "expected_min_score": 74,
            "contract_type": "jeonse",
            "property_type": "villa",
            "region": "수도권",
        ...
        {
            "scenario_id": "REALISTIC_044",
            "name": "폐업 중개사무소 공제증서 미제공",
            "expected_min_score": 72,
            "contract_type": "jeonse",
            "property_type": "apartment",
            "region": "수도권",
        ...
        {
            "scenario_id": "REALISTIC_045",
            "name": "보증서 캡처만 제시하고 조회 거부",
            "expected_min_score": 72,
            "contract_type": "jeonse",
            "property_type": "officetel",
            "region": "수도권",
        ...
        {
            "scenario_id": "REALISTIC_047",
            "name": "안전한 비대면 대리계약 서류 확인",
            "expected_max_score": 45,
            "contract_type": "jeonse",
            "property_type": "apartment",
            "region": "수도권",
        ...
        {
            "scenario_id": "REALISTIC_048",
            "name": "잔금 당일 최신 등기부 재열람 거부",
            "expected_min_score": 66,
            "contract_type": "jeonse",
            "property_type": "villa",
            "region": "수도권",
        ...
        {
            "scenario_id": "REALISTIC_049",
            "name": "금요일 잔금 후 월요일 전입 요구",
            "expected_min_score": 74,
            "contract_type": "jeonse",
            "property_type": "apartment",
            "region": "수도권",
        ...
        {
            "scenario_id": "REALISTIC_050",
            "name": "전세대출 브로커 명의대여 제안",
            "expected_min_score": 76,
            "contract_type": "jeonse",
            "property_type": "villa",
            "region": "수도권",
        ...
        {
            "scenario_id": "REALISTIC_051",
            "name": "임대인 가족 계좌 송금 요구",
            "expected_min_score": 74,
            "contract_type": "jeonse",
            "property_type": "multi_family",
            "region": "수도권",
        ...
        {
            "scenario_id": "REALISTIC_052",
            "name": "잔금 후 공사 완료 뒤 전입 요구",
            "expected_min_score": 74,
            "contract_type": "jeonse",
            "property_type": "officetel",
            "region": "수도권",
        ...
        {
            "scenario_id": "REALISTIC_053",
            "name": "안전한 최신 등기부·전입·대출 확인",
            "expected_max_score": 45,
            "contract_type": "jeonse",
            "property_type": "apartment",
            "region": "수도권",
